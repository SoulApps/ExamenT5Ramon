...
import static jackpot.Jackpot.MONEDA_1;
import static jackpot.Jackpot.MONEDA_2;
import static jackpot.Jackpot.MONEDA_50;
import static jackpot.Jackpot.deposito;
import static jackpot.Jackpot.premio;
import static jackpot.Jackpot.saldo;
...
//            
//           
//            numAleatorio[i] = String.valueOf(generadorNum.nextInt(4));
//            
//            System.out.println(numAleatorio[0]);
//            new ImageIcon(getClass().getResource("/imagenes/"+ numAleatorio.indexOf(0)+ ".png"));
//            new ImageIcon(getClass().getResource("/imagenes/"+ numAleatorio.indexOf(1)+ ".png"));
//            new ImageIcon(getClass().getResource("/imagenes/"+ numAleatorio.indexOf(2)+ ".png"));
//            
    }
////    }
    ...
    private void jButtonPalancaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPalancaActionPerformed
        ...
        for (int i = 0; i < 5; i++) {
            numerosGenerados = String.valueOf(generadorNum.nextInt(5));
        }
        for (int j = 0; j < 3; j++) {

            String numAleatorio[] = new String[3];

            numAleatorio[j] += numerosGenerados;

            jLabelImagen1.setIcon(new ImageIcon(getClass().getResource("imagenes/" + numAleatorio[1] + ".png")));
            jLabelImagen2.setIcon(new ImageIcon(getClass().getResource("imagenes/" + numAleatorio[1] + ".png")));
            jLabelImagen3.setIcon(new ImageIcon(getClass().getResource("imagenes/" + numAleatorio[2] + ".png")));
            
            //Premios chapuzas "no he encontrado otra manera y el tiempo me ha hecho que no pudiera hacerlo en un método"

            if (numerosGenerados.indexOf(0) == 0) {
                premio += 1;
            } else {
                if (numerosGenerados.indexOf(0) == 0 && numerosGenerados.indexOf(1) == 0) {
                    premio += 5;
                }

                if (numerosGenerados.indexOf(0) == 1 && numerosGenerados.indexOf(1) == 1 && numerosGenerados.indexOf(2) == 4) {

                    premio += 10;
                } else {
                    if (numerosGenerados.indexOf(0) == 1 && numerosGenerados.indexOf(1) == 1 && numerosGenerados.indexOf(2) == 1) {
                        premio += 10;
                    }
                }
            }
            if (numerosGenerados.indexOf(0) == 2 && numerosGenerados.indexOf(1) == 2 && numerosGenerados.indexOf(2) == 2) {
                premio += 15;
            } else {
                if (numerosGenerados.indexOf(0) == 2 && numerosGenerados.indexOf(1) == 2 && numerosGenerados.indexOf(2) == 4) {
                    premio += 15;
                }
            }
            if (numerosGenerados.indexOf(0) == 3 && numerosGenerados.indexOf(1) == 3 && numerosGenerados.indexOf(2) == 3) {
                premio += 20;
            } else {
                if (numerosGenerados.indexOf(0) == 3 && numerosGenerados.indexOf(1) == 3 && numerosGenerados.indexOf(2) == 4) {
                    premio += 20;
                }
            }
            if (numerosGenerados.indexOf(0) == 4 && numerosGenerados.indexOf(1) == 4 && numerosGenerados.indexOf(2) == 4) {
                premio += 100;
    ...
    private void jButton50centActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton50centActionPerformed
        ...
        deposito -= saldo;
        jLabelSaldo.setText(String.valueOf(Jackpot.getSaldo()));
